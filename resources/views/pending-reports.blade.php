                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        @php
                                        $fileExists =
                                        Storage::disk('pdfs')->exists("{$report->UnitNo}/auditPdfs/{$report->AuditName}");
                                        @endphp
                                        @if ($fileExists && isset($report->AuditName))
                                        <a href="{{ route('download.audit', ['unit' => $report->UnitNo, 'filename' => $report->AuditName]) }}"
                                            target="_blank" style="text-decoration:underline;cursor: pointer">

                                            <svg fill="#0d6efd" width="30px" height="30px" viewBox="0 0 1024 1024"
...
<script>
    ...
    commentModal.addEventListener('show.bs.modal', function (event) {
        ...
        if (published == '1') {
            ...
            document.getElementById('comment-modal-heading').textContent = 'Edit or change comments here.  Your previous comments were:';
